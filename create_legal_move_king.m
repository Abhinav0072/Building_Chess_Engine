function legal_moves=create_legal_move_king(for_which_color,current_state,up_color,up_piece,down_color,down_piece,left_color,left_piece,right_color,right_piece,dig_1_color,dig_1_piece,dig_2_color,dig_2_piece,dig_3_color,dig_3_piece,dig_4_color,dig_4_piece,queen_side_castling,king_side_castling)
 %% when file same
...
%% creating legal move for castling
