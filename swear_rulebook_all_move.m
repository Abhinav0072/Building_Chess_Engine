...
for i=1:m,
    ...
    if strcmp(current_status(i).status,'Alive')&&(and(strcmp(current_status(i).color,Color),(strcmp(current_status(i).piece,'Rook') || strcmp(current_status(i).piece,'Queen'))))
      ...
      for j=1:m,
          if and((j~=i),strcmp(current_status(j).status,'Alive'))
              ...
              % movement along the same file (vertical)
          ...
          % movement along the same rank (horizontal)
          elseif (current_status(j).rank==current_status(i).rank)
                  if (current_status(j).file>current_status(i).file)
                  ...
                  elseif (current_status(j).file<current_status(i).file)
                      if (current_status(j).file>=left_lowest)
                          left_lowest=current_status(j).file;
    ...
    if strcmp(current_status(i).status,'Alive')&&(and(strcmp(current_status(i).color,Color),(strcmp(current_status(i).piece,'Bishop') || strcmp(current_status(i).piece,'Queen'))))
        ...
        if third_closest_file_diff<third_closest_rank_diff
    ...
    if strcmp(current_status(i).status,'Alive')&&(and(strcmp(current_status(i).color,Color),strcmp(current_status(i).piece,'Knight')))
        ...
        file_down_left_piece='NA';
        file_up_right_piece='NA';
        file_up_left_piece='NA';
        ...
        rank_left_down_piece='NA';                      % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        rank_left_up_piece='NA';                        % ASSUMING THEY ARE NOT AVAILABLE FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        rank_right_down_piece='NA';                     % ASSUMING THEY ARE NOT AVAILABLE FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        rank_right_up_piece='NA';   
    ...
    if strcmp(current_status(i).status,'Alive')&&(and(strcmp(current_status(i).color,Color),strcmp(current_status(i).piece,'King')))
        ...
        up_piece='NA';                          % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        down_piece='NA';                        % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        left_piece='NA';                        % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        right_piece='NA';                       % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        dig_1_piece='NA';                       % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        dig_2_piece='NA';                       % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        dig_3_piece='NA';                       % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
        dig_4_piece='NA';                       % ASSUMING THEY ARE NOT AVAILABLE (NOT VALID OR OUT OF BOUND) FIRST, THEN IF THEY ARE,UPDATING ACCORDINGLY.
    ...
    if strcmp(current_status(i).status,'Alive')&&(and(strcmp(current_status(i).color,Color),strcmp(current_status(i).piece,'pawn')))
